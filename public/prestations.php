...
<head>
    ...
    <meta charset="utf-8">
    <meta name="Klap Affaires Préstation">
...
<section id="presta-container" class="container-fluid">
    ...
    <div class="col-xs-12 col-md-4 col-md-offset-1 imgpresta">
        <img  src="http://videoscopie.com/images/Illustration/Camera-operator-setting-up-the-video-camera_jwawkins.png" alt="vocal coaching">
    </div>
    <div class="col-xs-12 col-md-7 presta-text">
        <p>Le <strong>coaching video</strong> s’adresse à toute personne souhaitant découvrir,
